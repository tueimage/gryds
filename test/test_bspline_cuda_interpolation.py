...
class TestLinearInterpolator(TestCase):
    ...
    def test_2d_bspline_cuda_interpolator_90_deg_rotation(self):
        ...
        intp = gryds.interpolators.bspline_cuda.bspline_cuda(image)
    ...
    def test_2d_bspline_cuda_interpolator_45_deg_rotation(self):
        ...
        intp = gryds.interpolators.bspline_cuda.bspline_cuda(image, mode='mirror')
    ...
    def test_bspline_cuda_interpolator_error(self):
        ...
        self.assertRaises(ValueError, gryds.interpolators.bspline_cuda.bspline_cuda, image)
