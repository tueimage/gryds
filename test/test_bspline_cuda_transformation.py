...
import numpy as np
import gryds
import gryds.transformers.bspline_cuda
DTYPE = gryds.DTYPE
...
class TestBSplineCudaTransformation(TestCase):
    ...
    def test_translation_bspline_2d(self):
        ...
        trf = gryds.transformers.bspline_cuda.BSplineTransformationCUDA(bspline_grid)
    ...
    def test_bspline_2d_folding(self):
        ...
        trf = gryds.transformers.bspline_cuda.BSplineTransformationCUDA(bspline_grid, order=1)
    ...
    def test_bspline_wrong_grid_size(self):
        ...
        self.assertRaises(ValueError, gryds.transformers.bspline_cuda.BSplineTransformationCUDA, bspline_grid)
